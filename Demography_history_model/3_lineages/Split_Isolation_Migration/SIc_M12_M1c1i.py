...
def SIC_M1c1i(params, ns, pts):
    N1, N2a, N2, N3, T2, T1, mci, mic, m12, m21 = params
    ...
    phi = dadi.Integration.three_pops(phi, xx, T1, nu1=N1, nu2=N2, nu3=N3, m12=0.0, m13=0, m21=0.0, m23=mic, m31=0, m32=mci)
    ## simulate the fs
...
for jj in range(0, 10):
    ...
    upper_bound = [10, 10, 10, 10, 10, 10, 100, 100, 100, 100]
    ...
    print
    'Parameters:', popt
    fout = open('SIc_M12_M1c1i.xls', 'a')
    fout.write('1st_anneal_optimization\t3pops_SIC_M12_M1c1i\t' + str(ll_opt) + '\t' + str(theta) + '\t' + str(popt).replace('\n',
                                                                                                                   '') + '\t' + str(
        AIC) + '\n')
...
for jj in range(0, 5):
    ...
    fout = open('SIc_M12_M1c1i.xls', 'a')
    fout.write('2nd_otimization\t3pops_SIC_M12_M1c1i\t' + str(ll_opt) + '\t' + str(theta) + '\t' + str(popt).replace('\n',
                                                                                                           '') + '\t' + str(
        AIC) + '\n')
    fout.close()