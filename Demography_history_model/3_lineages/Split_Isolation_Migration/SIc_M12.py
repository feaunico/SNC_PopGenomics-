...
def SIC_M12(params, ns, pts):
    N1, N2a, N2, N3, T2, T1, m12, m21 = params
...
for jj in range(0, 10):
    ...
    upper_bound = [10, 10, 10, 10, 10, 10, 100, 100, ]
    ...
    print
    'Parameters:', popt
    fout = open('SIC_M12.xls', 'a')
    fout.write('1st_anneal_optimization\t3pops_SIC_M12\t' + str(ll_opt) + '\t' + str(theta) + '\t' + str(popt).replace('\n',
                                                                                                                   '') + '\t' + str(
        AIC) + '\n')
...
for jj in range(0, 5):
    ...
    fout = open('SIC_M12.xls', 'a')
    fout.write('2nd_otimization\t3pops_SIC_M12\t' + str(ll_opt) + '\t' + str(theta) + '\t' + str(popt).replace('\n',
                                                                                                           '') + '\t' + str(
        AIC) + '\n')
    fout.close()