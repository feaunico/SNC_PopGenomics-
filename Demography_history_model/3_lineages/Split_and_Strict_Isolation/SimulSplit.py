...
for jj in range(0,10):
    ...
    fout = open('SimulSplit.xls','a')
    fout.write('1st_anneal_optimization\t3pops_Sim\t' + str(ll_opt) + '\t' + str(theta) + '\t' + str(popt).replace('\n','') + '\t' + str(AIC) + '\n')
...
for jj in range(0, 5):
    ...
    fout = open('SimulSplit.xls','a')
    fout.write('2nd_otimization\t3pops_Sim\t' + str(ll_opt) + '\t' + str(theta) + '\t' + str(popt).replace('\n','') + '\t' + str(AIC) + '\n')
    fout.close()