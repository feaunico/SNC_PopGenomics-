...
def SIB(params, ns, pts):
    N1,Na2,N2,N3,T2,T1 = params
    xx = dadi.Numerics.default_grid(pts)
    phi = dadi.PhiManip.phi_1D(xx)
    phi = dadi.PhiManip.phi_1D_to_2D(xx,phi)
    phi = dadi.Integration.two_pops(phi, xx, T2, nu1=N1, nu2=Na2, m12=0., m21=0.)
    ## split between AB and ABPG - PG comes directly from ancestral
    phi = dadi.PhiManip.phi_2D_to_3D_split_1(xx, phi)  #split between 1 and 3
