...
os.system('mkdir racon_polishing')
os.system('mkdir racon_polishing/mappings')
os.system('mkdir pilon_polishing')
os.system('mkdir pilon_polishing/mappings')

ON =  './202311201/run2/barcode05/barcode05.fastq.gz'    #path to fastq.gz with Oxford Nanopore reads

os.system('../Flye/bin/flye --nano-raw ' + ON + ' --genome-size 35 --threads 12 -o flye_genome --iterations 1')

genome = 'flye_genome/assembly.fasta'
os.system('../minimap2/minimap2 -a -t 6 ' + genome + ' ' + ON + ' > racon_polishing/mappings/map1.sam')
os.system('racon -t 6 ' + ON + ' racon_polishing/mappings/map1.sam ' + genome + ' > racon_polishing/assembly_pol1.fasta')

os.system('../minimap2/minimap2 -a -t 6 racon_polishing/assembly_pol1.fasta ' + ON + ' > racon_polishing/mappings/map2.sam')
os.system('racon -t 6 ' + ON + ' racon_polishing/mappings/map2.sam racon_polishing/assembly_pol1.fasta > racon_polishing/assembly_pol2.fasta')

os.system('../minimap2/minimap2 -a -t 6 racon_polishing/assembly_pol2.fasta ' + ON + ' > racon_polishing/mappings/map3.sam')
os.system('racon -t 6 ' + ON + ' racon_polishing/mappings/map3.sam racon_polishing/assembly_pol2.fasta > racon_polishing/assembly_pol3.fasta')

os.system('../minimap2/minimap2 -a -t 6 racon_polishing/assembly_pol3.fasta ' + ON + ' > racon_polishing/mappings/map4.sam')
os.system('racon -t 6 ' + ON + ' racon_polishing/mappings/map4.sam racon_polishing/assembly_pol3.fasta > racon_polishing/assembly_pol4.fasta')

lib1 = './NS.LH00487_0005.006.IDT_i7_182---IDT_i5_182.DfE-5_R1.fastq.gz'#path to fastq.gz with Illumina paired end reads - mate 1
lib2 = './NS.LH00487_0005.006.IDT_i7_182---IDT_i5_182.DfE-5_R2.fastq.gz'#path to fastq.gz with Illumina paired end reads - mate 2
#1
